...
setup, the testing policy and the DCO sign-off.**Start with the [Where to start](https://github.com/vyncint/termlens/blob/main/CONTRIBUTING.md#where-to-start)section.** Three things to know before
